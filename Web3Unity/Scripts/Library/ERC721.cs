...
namespace ChainSafeGamingSDK
{
    namespace ChainSafeERC721
    {
        public class ERC721
        {
            ...
            public static async Task<int> BalanceOf(string _chain, string _network, string _contract, string _account,
                string _rpc = "")
            {
            ...
            public static async Task<List<string>> OwnerOfBatch(string _chain, string _network, string _contract,
                string[] _tokenIds, string _multicall = "", string _rpc = "")
            {
                string method = "ownerOf";
                // build array of args
